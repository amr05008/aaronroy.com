...
I was shocked that Fable's safeguards stopped my scan before finishing.
...
When basic security questions that can be handled by open source tooling are something Fable is treating as potentially malicious, it's a maddening experience.
...
Hopefully in the days ahead as more folks run into these issues, more thoughtful safeguards will be put into place because I don't think it's a good outcome that Anthropic's current "best model," Fable 5, is unusable for baseline defensive cybersecurity work.
